...
import net.rizov.balloondestroyer.room.entity.Balloon;
...
public class BalloonGenerator {
    ...
    private BalloonFactory tntBalloonFactory = new BalloonFactory() {
        ...
        public Balloon createBalloon(RoomEntity parent) {
            Balloon balloon = new net.rizov.balloondestroyer.room.entity.Balloon(parent, playAtlas.findRegion("balloon-tnt"), playAtlas.findRegion("balloon-burst-tnt"), sounds[3], new Ellipse(
                    new Vector2(0, 0),
                    54,
                    80
            ));
	...
	private BalloonFactory[] factories = new BalloonFactory[] {
		...
		new BalloonFactory() {
			@Override
			public Balloon createBalloon(RoomEntity parent) {
				Balloon balloon = new net.rizov.balloondestroyer.room.entity.Balloon(parent, playAtlas.findRegion("balloon-red"), playAtlas.findRegion("balloon-burst-red"), sounds[0], new Ellipse(
						new Vector2(0, 0),
						98,
						128
				));
		...
		new BalloonFactory() {
			@Override
			public Balloon createBalloon(RoomEntity parent) {
				Balloon balloon = new net.rizov.balloondestroyer.room.entity.Balloon(parent, playAtlas.findRegion("balloon-blue"), playAtlas.findRegion("balloon-burst-blue"), sounds[1], new Ellipse(
						new Vector2(0, 0),
						79,
						130
				));
		...
		new BalloonFactory() {
			@Override
			public Balloon createBalloon(RoomEntity parent) {
				Balloon balloon = new net.rizov.balloondestroyer.room.entity.Balloon(parent, playAtlas.findRegion("balloon-yellow"), playAtlas.findRegion("balloon-burst-yellow"), sounds[2], new Ellipse(
						new Vector2(0, 0),
						73,
						107
				));
	...
	public net.rizov.balloondestroyer.room.entity.Balloon generate(Room<?, ?> room) {
	...
	public net.rizov.balloondestroyer.room.entity.Balloon createBalloon(Room<?, ?> room, BalloonType type) {
		return factories[type.getValue()].createBalloon(room);
	}

    public net.rizov.balloondestroyer.room.entity.Balloon createTntBalloon(Room<?, ?> room) {
