...
import net.rizov.balloondestroyer.room.play.entity.BalloonGenerator.BalloonType;
...
public class Wave extends RoomEntity {
	...
	private Array<net.rizov.balloondestroyer.room.entity.Balloon> balloons;
	...
	public Wave(RoomEntity parent, Time time) {
		...
		balloons = new Array<net.rizov.balloondestroyer.room.entity.Balloon>();
	...
	public void update(float deltaTime) {
		if (running) {
			...
			for (net.rizov.balloondestroyer.room.entity.Balloon balloon : balloons) {
